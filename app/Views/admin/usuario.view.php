                    ...
                    <table id="tabladatos" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($usuarios as $u) {
                                ?>
                                <tr>
                                    <td><img src="assets/img/usuarios/avatar-<?php echo $u['id_usuario'] . "."; ?><?php echo file_exists("assets/img/usuarios/avatar-" . $u["id_usuario"] . ".png") ? "png" : "jpg" ?>" alt="Avatar usuario <?php echo $u['id_usuario'] ?>" class="img-circle imagenes-usuarios"></td>
