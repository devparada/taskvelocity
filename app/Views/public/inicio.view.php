...
<html lang="es">
    ...
    <main>
        ...
        <div class="reseñas">
            ...
            <div id="resenas-grid">
                <div class="resena"><img src="assets/img/opiniones/opinion-1" alt="Imagen resena 1" class="imagenes-pequenas imagenes-resenas"></img><p>Esta herramienta es fácil de usar y es útil para gestionar el día a día</p></div>
                <div class="resena"><img src="assets/img/opiniones/opinion-2" alt="Imagen resena 2" class="imagenes-pequenas imagenes-resenas"></img><p>Esta herramienta es minimalista y simple que ayuda a gestionar los proyectos y tareas facilmente</p></div>
                <div class="resena"><img src="assets/img/opiniones/opinion-3" alt="Imagen resena 3" class="imagenes-pequenas imagenes-resenas"></img><p>Esta aplicación me ayuda a gestionar mi día a día en el trabajo</p></div>
                <div class="resena"><img src="assets/img/opiniones/opinion-4" alt="Imagen resena 4" class="imagenes-pequenas imagenes-resenas"></img><p>Esta aplicación ayuda en el trabajo a gestionar nuestros futuros proyectos<p></div>
            </div>
        </div>
