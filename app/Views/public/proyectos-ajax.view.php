...
<?php if (empty($proyectos)) { ?>
    <div class="informacion">
        <p><i class="fa-solid fa-circle-info"></i> Crea tu primer proyecto pulsando en el botón Crear un proyecto</p>
    </div>
<?php } ?>
            ...
            <?php } else { ?>
                ...
                <div class="informacion-proyecto">
                    ...
                    <?php if ($p["editable"] == 1) { ?>
                        ...
                        <p class="miembros-proyecto-tarea enlace-imagen-perfil">
                            <?php foreach ($p["nombresUsuarios"] as $nombreUsuario) { ?>
                                <?php foreach ($usuarios as $u) { ?>
                                    <?php if ($u["username"] == $nombreUsuario) { ?>
                                        <a href="/perfil/<?php echo $u["id_usuario"] ?>" class="enlace-imagen-perfil"><img src="/assets/img/usuarios/avatar-<?php echo $u["id_usuario"] ?>?>" alt="Avatar <?php echo ($u["username"] == $_SESSION["usuario"]["username"]) ? "Tú" : $u["username"] ?>" class="imagen-perfil-pequena"><?php echo ($u["username"] == $_SESSION["usuario"]["username"]) ? "Tú" : $u["username"] ?></a>
                                    <?php } ?>
                                <?php } ?>
                                <?php } ?></p>
                        ...
                        <div class="botones-proyecto-tarea">
                            ...
                            <?php if ($p["id_usuario_proyecto_prop"] == $_SESSION["usuario"]["id_usuario"]) { ?>
